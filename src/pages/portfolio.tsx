            ...
            {projects.map((project, index) => (
              ...
              >
                <Link to={project.href}>
                  <Card className="group overflow-hidden cursor-pointer h-full flex flex-col !rounded-xl">
                    <div className="relative aspect-square overflow-hidden">
                      ...
                      {(project.customText || project.title === "XMET") ? (
                        <LogoBackground
                      ...
                      <div className="absolute top-2 right-2 flex gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-30">
                        <Button size="icon" variant="glass" className="h-7 w-7">
